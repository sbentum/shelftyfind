          ...
          <div id="slider-carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="item active">
                <div class="col-sm-6">
                  <<h1><span>shelfty</span>find</h1>
                  <h2>shelftyfind</h2>
                  <p>Find you product with ease <br>
Shelftyfind: Your convenient shopping partner   </p>
              ...
              <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                      ...
                      <button type="submit" name="btnorder" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Locate Me</button>
                    </div>
