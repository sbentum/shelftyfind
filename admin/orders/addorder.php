              ...
              <tbody>
                <?php  
                  ...
                  foreach ($cur as $result) {
                    ...
                    // echo '<td align="left">
                    // <a href="controller.php?action=cartadd&id='.$result->PRODUCTID.'&price='.$result->PRICE.'" class="btn btn_fixnmix btn-xs"><strong>Locate Me</strong></a></td>';
                      echo '<td align="left">
                    <a href="index.php?view=addtocart"   data-id="'.$result->PRODUCTID.'" class="btn btn_fixnmix btn-xs MAINorder"><strong>Locate Me</strong></a></td>';
                    //  echo '<td align="left">
                    // <a href="" data-target="#CART" data-toggle="modal"  data-id="'.$result->PRODUCTID.'" class="btn btn_fixnmix btn-xs MAINorder"><strong>Locate Me</strong></a></td>';
                    echo '</tr>';
                  } 
                  ?>
              </tbody>            
